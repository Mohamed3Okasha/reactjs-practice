        ...
        return (
            <React.Fragment>
                ...
                <main className="container">
                    <Routes>
                        <Route path='/add-product/:id' element={<AddProduct products = {this.state.products} onAdd={this.handleAddEditProduct} />} />
                        ...
                        <Route path='/login' element= {<Login onSubmit = {this.handleSubmit}/>} />
